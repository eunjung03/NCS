 ...
 *              - 따라서 직접 접근을 못하게 제어하고 
 *                메서드(setter() / getter())를 사용하여 접근하게 함.
 * 2. default : - 동일한 패키지에서만 접근이 가능. 생략이 가능함.
 ...
 *               다른 패키지의 상속 관계에 있는 클래스의 멤버, 다른 패키지의 클래스 멤버까지 접근이 가능함.
...
public class Super {
	...
	// 멤버변수
	private int num1 = 10;		// 접근 지정자 : private
