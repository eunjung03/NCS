...
public class Ex03 {
	...
	public static void main(String[] args) {
		...
		System.out.println("대문자 >>> " + str.toUpperCase()); // 주소값 다른 메모리에 저장됨.
		System.out.println("소문자 >>> " + (str.toUpperCase()).toLowerCase());
		
		System.out.println("str 주소 >>> "+System.identityHashCode(str));
		System.out.println("str 대문자 주소 >>> "+System.identityHashCode(str.toUpperCase()));
		System.out.println();
