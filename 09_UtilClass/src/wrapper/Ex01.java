...
public class Ex01 {
	...
	public static void main(String[] args) {
		...
		System.out.println(in);	// 참조변수가 주소값이 아니라 값을 가짐
		System.out.println(in + 35);
		
		Integer in1 = new Integer(100);	// 서로 다른 주소를 가짐
		System.out.println("in.equals(in1) >>> " + in.equals(in1));	// 같은 값을 가지고 있어서 true 반환
		
		System.out.println("int형 >>> " + in1.intValue()); 	// 언박싱 : 참조형 -> 자료형으로
