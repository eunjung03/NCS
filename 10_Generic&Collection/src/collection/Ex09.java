 ...
 *    - key와 value를 한 쌍으로 해서 데이터를 저장하고, 검색하는 기능을 제공.
 *    - key는 중복 불가, value는 중복 가능.
 *    - Map 인터페이스의 자식 클래스로 구현.
 *      ==> HashMap(O), HashTable(O), Properties(가끔 사용), TreeMap(X)
 */
...
public class Ex09 {
	...
	public static void main(String[] args) {
		...
		for(String key : map.keySet()) {
			System.out.println(key + "님의 점수 >>> "+map.get(key)+"점");
		}
