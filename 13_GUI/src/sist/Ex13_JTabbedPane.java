...
public class Ex13_JTabbedPane {
	...
	public static void main(String[] args) {
		...
		// 2-1-2. 첫번째 탭의 컴포넌트들을 컨테이너(jp1)에 올려야 한다.
		jp1.add(jb1);  jp1.add(jb2);  jp1.add(jb3);
		
		// 2-2-1. 두번째 탭에 올려질 컴포넌트를 만들어 보자.
		...
		// 2-2-2. 두번째 탭의 컴포넌트들을 컨테이너(jp2)에 올려야 한다.
		...
		// 2-3-2. 세번째 탭의 컴포넌트들을 컨테이너(jp3)에 올려야 한다.
