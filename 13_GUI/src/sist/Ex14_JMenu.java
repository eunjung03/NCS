...
public class Ex14_JMenu {

	public static void main(String[] args) {

		JFrame jf = new JFrame("메뉴");	// 메뉴 만들때 주의점 : 메뉴는 컨테이너가 없음.
		...
		JMenu jMenu4 = new JMenu("글자체");	// 메뉴 아이템
		JMenu jMenu5 = new JMenu("바탕색");	// 메뉴 아이템
		
		// 2. 메뉴 아이템을 만들어 보자.
		// 2-1. "파일" 이라는 메뉴에 들어갈 메뉴 아이템 설정.
		...
		// 5. 메뉴바를 프레임에 올려야 한다. add() 쓰면 안 됨. setJMenuBar 사용. 
		jf.setJMenuBar(bar);
